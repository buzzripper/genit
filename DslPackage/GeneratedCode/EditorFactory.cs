...
namespace Dyvenix.GenIt
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.GenItEditorFactoryId)]
	internal partial class GenItEditorFactory : GenItEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new GenItEditorFactory.
		/// </summary>
		public GenItEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class GenItEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected GenItEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new GenItDocData(this.ServiceProvider, typeof(GenItEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new GenItDocView(docData, this.ServiceProvider);
		}
	}
}
