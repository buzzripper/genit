...
namespace Dyvenix.GenIt
{
	...
	{
		/// <summary>
		/// Constructs a new GenItCommandSet.
		/// </summary>
		public GenItCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class GenItCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new GenItCommandSetBase.
		/// </summary>
		protected GenItCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewGenItExplorerCommand,
				typeof(GenItEditorFactory).GUID);
		...
		{
			GenItExplorerToolWindow explorer = this.GenItExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected GenItDocData CurrentGenItDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as GenItDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected GenItDocView CurrentGenItDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as GenItDocView;
			}
		}
		...
		/// </summary>
		protected GenItExplorerToolWindow GenItExplorerToolWindow
		{
			get
			{
				GenItExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(GenItExplorerToolWindow), true) as GenItExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				GenItExplorerToolWindow explorerWindow = this.GenItExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class GenItClipboardCommandSet : GenItClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new GenItClipboardCommandSet.
		/// </summary>
		public GenItClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class GenItClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new GenItClipboardCommandSetBase.
		/// </summary>
		protected GenItClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
