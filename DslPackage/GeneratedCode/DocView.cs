...
namespace Dyvenix.GenIt
{
	...
	/// </summary>
	internal partial class GenItDocView : GenItDocViewBase
	{
		/// <summary>
		/// Constructs a new GenItDocView.
		/// </summary>
		public GenItDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class GenItDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new GenItDocView.
		/// </summary>
		protected GenItDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			GenItDocDataBase docData = this.DocData as GenItDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for GenItDocViewBase should be an GenItDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Dyvenix.GenIt.GenItDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Dyvenix.GenIt.GenItDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Dyvenix.GenIt.GenItToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Dyvenix.GenIt.GenItToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.GenItDiagramMenu;
			}
		}
			...
			if(global::Dyvenix.GenIt.GenItHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Dyvenix.GenIt.GenItHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
