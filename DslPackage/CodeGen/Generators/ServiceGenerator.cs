...
//			var _outputDir = Path.Combine(CodeGenUtils.SolutionRootPath, module.RootFolder, "Services", serviceModel.Version);
//			Directory.CreateDirectory(_outputDir);  // Ensure output dir exists
...
//			// Namespace 		
//			fileContent.AddLine();
//			fileContent.AddLine(0, $"namespace {_modelRoot.EntitiesNamespace}.{serviceModel.Version}.Services;");
...
//			// Declaration
//			fileContent.AddLine();
//			fileContent.AddLine(0, $"public partial class {serviceName}");
