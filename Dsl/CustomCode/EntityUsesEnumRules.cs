...
{
    /// <summary>
    /// Rule that fires when an EntityUsesEnum relationship is created.
    /// Creates a PropertyModel on the Entity with DataType = Enum and sets EnumTypeName.
    /// </summary>
    [RuleOn(typeof(EntityUsesEnum), FireTime = TimeToFire.TopLevelCommit)]
    public class EntityUsesEnumAddRule : AddRule
    {
        public override void ElementAdded(ElementAddedEventArgs e)
        {
            var link = e.ModelElement as EntityUsesEnum;
    ...
    /// <summary>
    /// Rule that fires when an EntityUsesEnum relationship is being deleted.
    /// Deletes the associated PropertyModel.
    /// </summary>
    [RuleOn(typeof(EntityUsesEnum), FireTime = TimeToFire.TopLevelCommit)]
    public class EntityUsesEnumDeleteRule : DeleteRule
    {
    ...
    /// Deletes the associated EntityUsesEnum relationship if it's an enum property.
    /// </summary>
    ...
    public class PropertyModelDeleteRule : DeletingRule
    {
        public override void ElementDeleting(ElementDeletingEventArgs e)
        {
            ...
            // Find the associated EntityUsesEnum link
    ...
    /// <summary>
    /// Rule that fires when EntityUsesEnum.PropertyName changes.
    /// Updates the associated PropertyModel's name.
    /// </summary>
    [RuleOn(typeof(EntityUsesEnum), FireTime = TimeToFire.TopLevelCommit)]
    public class EntityUsesEnumPropertyNameChangeRule : ChangeRule
    {
        public override void ElementPropertyChanged(ElementPropertyChangedEventArgs e)
        {
            if (e.DomainProperty.Id != EntityUsesEnum.PropertyNameDomainPropertyId)
                return;
