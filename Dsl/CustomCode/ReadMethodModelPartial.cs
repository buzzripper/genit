...
namespace Dyvenix.GenIt
{
    ...
    public partial class ReadMethodModel
    {
        ...
        public bool IsSingle
        {
            get
            {
                if (!this.FilterProperties.Any())
                    return false;
                return !this.InclPaging && !this.InclSorting && !this.FilterProperties.Any(fp => fp.IsPartialMatch) && !this.FilterProperties.Any(fp => !fp.PropertyModel.IsIndexUnique);
            }
        }
