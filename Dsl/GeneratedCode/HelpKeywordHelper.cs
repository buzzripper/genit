...
namespace Dyvenix.GenIt
{
	...
	/// </remarks>
	public partial class GenItHelpKeywordHelper : GenItHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new GenItHelpKeywordHelper.
		/// </summary>
		protected GenItHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the GenItHelpKeywordHelper.
		/// </summary>
		public static GenItHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class GenItHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new GenItHelpKeywordHelperBase.
		/// </summary>
		protected GenItHelpKeywordHelperBase()
			: base() { }
