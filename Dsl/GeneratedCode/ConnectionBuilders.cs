...
namespace Dyvenix.GenIt
{
			...
			else // Check combinations
			{
				if (candidateSource is global::Dyvenix.GenIt.ReadMethodModel)
				{
					if (candidateTarget is global::Dyvenix.GenIt.FilterPropertyModel)
					{
						...
						if(targetFilterPropertyModel == null || global::Dyvenix.GenIt.ReadMethodModelHasFilterProperties.GetLinkToReadMethodModel(targetFilterPropertyModel) != null) return false;
			...
			else // Check combinations
			{
				if (candidateSource is global::Dyvenix.GenIt.UpdateMethodModel)
				{
					if (candidateTarget is global::Dyvenix.GenIt.UpdatePropertyModel)
					{
						...
						if(targetUpdatePropertyModel == null || global::Dyvenix.GenIt.UpdateMethodModelHasUpdateProperties.GetLinkToUpdateMethodModel(targetUpdatePropertyModel) != null) return false;
			...
			else // Check combinations
			{
				if (candidateSource is global::Dyvenix.GenIt.ServiceModel)
				{
					if (candidateTarget is global::Dyvenix.GenIt.ReadMethodModel)
					{
						...
						if(targetReadMethodModel == null || global::Dyvenix.GenIt.ServiceModelHasReadMethodModels.GetLinkToServiceModel(targetReadMethodModel) != null) return false;
			...
			else // Check combinations
			{
				if (candidateSource is global::Dyvenix.GenIt.ServiceModel)
				{
					if (candidateTarget is global::Dyvenix.GenIt.UpdateMethodModel)
					{
						...
						if(targetUpdateMethodModel == null || global::Dyvenix.GenIt.ServiceModelHasUpdateMethods.GetLinkToServiceModel(targetUpdateMethodModel) != null) return false;
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class ServiceModelHasDtoModelsBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::Dyvenix.GenIt.DtoModel)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			else // Check combinations
			{
				if (candidateSource is global::Dyvenix.GenIt.ServiceModel)
				{
					if (candidateTarget is global::Dyvenix.GenIt.DtoModel)
					{
						global::Dyvenix.GenIt.ServiceModel sourceServiceModel = (global::Dyvenix.GenIt.ServiceModel)candidateSource;
						global::Dyvenix.GenIt.DtoModel targetDtoModel = (global::Dyvenix.GenIt.DtoModel)candidateTarget;
						if(targetDtoModel == null || global::Dyvenix.GenIt.ServiceModelHasDtoModels.GetLinkToServiceModel(targetDtoModel) != null) return false;
						if(targetDtoModel == null || sourceServiceModel == null || global::Dyvenix.GenIt.ServiceModelHasDtoModels.GetLinks(sourceServiceModel, targetDtoModel).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Dyvenix.GenIt.ServiceModel)
				{
					if (target is global::Dyvenix.GenIt.DtoModel)
					{
						global::Dyvenix.GenIt.ServiceModel sourceAccepted = (global::Dyvenix.GenIt.ServiceModel)source;
						global::Dyvenix.GenIt.DtoModel targetAccepted = (global::Dyvenix.GenIt.DtoModel)target;
						DslModeling::ElementLink result = new global::Dyvenix.GenIt.ServiceModelHasDtoModels(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class DtoModelReferencesPropertyModelsBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Dyvenix.GenIt.DtoModel)
				{
					if (candidateTarget is global::Dyvenix.GenIt.PropertyModel)
					{
						global::Dyvenix.GenIt.DtoModel sourceDtoModel = (global::Dyvenix.GenIt.DtoModel)candidateSource;
						global::Dyvenix.GenIt.PropertyModel targetPropertyModel = (global::Dyvenix.GenIt.PropertyModel)candidateTarget;
						if(targetPropertyModel == null || sourceDtoModel == null || global::Dyvenix.GenIt.DtoModelReferencesPropertyModels.GetLinks(sourceDtoModel, targetPropertyModel).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Dyvenix.GenIt.DtoModel)
				{
					if (target is global::Dyvenix.GenIt.PropertyModel)
					{
						global::Dyvenix.GenIt.DtoModel sourceAccepted = (global::Dyvenix.GenIt.DtoModel)source;
						global::Dyvenix.GenIt.PropertyModel targetAccepted = (global::Dyvenix.GenIt.PropertyModel)target;
						DslModeling::ElementLink result = new global::Dyvenix.GenIt.DtoModelReferencesPropertyModels(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class DtoModelReferencesNavigationPropertiesBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::Dyvenix.GenIt.NavigationProperty)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			else // Check combinations
			{
				if (candidateSource is global::Dyvenix.GenIt.DtoModel)
				{
					if (candidateTarget is global::Dyvenix.GenIt.NavigationProperty)
					{
						global::Dyvenix.GenIt.DtoModel sourceDtoModel = (global::Dyvenix.GenIt.DtoModel)candidateSource;
						global::Dyvenix.GenIt.NavigationProperty targetNavigationProperty = (global::Dyvenix.GenIt.NavigationProperty)candidateTarget;
						if(targetNavigationProperty == null || sourceDtoModel == null || global::Dyvenix.GenIt.DtoModelReferencesNavigationProperties.GetLinks(sourceDtoModel, targetNavigationProperty).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Dyvenix.GenIt.DtoModel)
				{
					if (target is global::Dyvenix.GenIt.NavigationProperty)
					{
						global::Dyvenix.GenIt.DtoModel sourceAccepted = (global::Dyvenix.GenIt.DtoModel)source;
						global::Dyvenix.GenIt.NavigationProperty targetAccepted = (global::Dyvenix.GenIt.NavigationProperty)target;
						DslModeling::ElementLink result = new global::Dyvenix.GenIt.DtoModelReferencesNavigationProperties(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class EntityModelReferencesDtoModelsBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
			...
			else // Check combinations
			{
				if (candidateSource is global::Dyvenix.GenIt.EntityModel)
				{
					if (candidateTarget is global::Dyvenix.GenIt.DtoModel)
					{
						global::Dyvenix.GenIt.EntityModel sourceEntityModel = (global::Dyvenix.GenIt.EntityModel)candidateSource;
						global::Dyvenix.GenIt.DtoModel targetDtoModel = (global::Dyvenix.GenIt.DtoModel)candidateTarget;
						if(targetDtoModel == null || sourceEntityModel == null || global::Dyvenix.GenIt.EntityModelReferencesDtoModels.GetLinks(sourceEntityModel, targetDtoModel).Count > 0) return false;
						return true;
					}
				}
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Dyvenix.GenIt.EntityModel)
				{
					if (target is global::Dyvenix.GenIt.DtoModel)
					{
						global::Dyvenix.GenIt.EntityModel sourceAccepted = (global::Dyvenix.GenIt.EntityModel)source;
						global::Dyvenix.GenIt.DtoModel targetAccepted = (global::Dyvenix.GenIt.DtoModel)target;
						DslModeling::ElementLink result = new global::Dyvenix.GenIt.EntityModelReferencesDtoModels(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class ReadMethodModelReferencesReturnDtoBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
			...
			else // Check combinations
			{
				if (candidateSource is global::Dyvenix.GenIt.ReadMethodModel)
				{
					if (candidateTarget is global::Dyvenix.GenIt.DtoModel)
					{
						global::Dyvenix.GenIt.ReadMethodModel sourceReadMethodModel = (global::Dyvenix.GenIt.ReadMethodModel)candidateSource;
						global::Dyvenix.GenIt.DtoModel targetDtoModel = (global::Dyvenix.GenIt.DtoModel)candidateTarget;
						if(sourceReadMethodModel == null || global::Dyvenix.GenIt.ReadMethodModelReferencesReturnDto.GetLinkToReturnDto(sourceReadMethodModel) != null) return false;
						if(targetDtoModel == null || sourceReadMethodModel == null || global::Dyvenix.GenIt.ReadMethodModelReferencesReturnDto.GetLinks(sourceReadMethodModel, targetDtoModel).Count > 0) return false;
						return true;
					}
				}
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Dyvenix.GenIt.ReadMethodModel)
				{
					if (target is global::Dyvenix.GenIt.DtoModel)
					{
						global::Dyvenix.GenIt.ReadMethodModel sourceAccepted = (global::Dyvenix.GenIt.ReadMethodModel)source;
						global::Dyvenix.GenIt.DtoModel targetAccepted = (global::Dyvenix.GenIt.DtoModel)target;
						DslModeling::ElementLink result = new global::Dyvenix.GenIt.ReadMethodModelReferencesReturnDto(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
