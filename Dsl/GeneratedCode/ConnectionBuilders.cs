...
namespace Dyvenix.GenIt
{
	...
	public static partial class EnumAssociationBuilder
	{
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			else // Check combinations
			{
				if (candidateSource is global::Dyvenix.GenIt.EntityModel)
				{
					if (candidateTarget is global::Dyvenix.GenIt.EnumModel)
					{
						global::Dyvenix.GenIt.EntityModel sourceEntityModel = (global::Dyvenix.GenIt.EntityModel)candidateSource;
						global::Dyvenix.GenIt.EnumModel targetEnumModel = (global::Dyvenix.GenIt.EnumModel)candidateTarget;
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Dyvenix.GenIt.EntityModel)
				{
					if (target is global::Dyvenix.GenIt.EnumModel)
					{
						global::Dyvenix.GenIt.EntityModel sourceAccepted = (global::Dyvenix.GenIt.EntityModel)source;
						global::Dyvenix.GenIt.EnumModel targetAccepted = (global::Dyvenix.GenIt.EnumModel)target;
	...
	/// Handles interaction between the ConnectionBuilder and the corresponding ConnectionTool.
	/// </summary>
	internal partial class EnumAssociationConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new EnumAssociationConnectAction for the given Diagram.
		/// </summary>
		public EnumAssociationConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the EnumAssociationConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			if(this.connectionTypes == null)
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new EnumAssociationConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class EnumAssociationConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the EnumAssociationConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected EnumAssociationConnectionTypeBase() : base() {}
		...
		private partial class EnumAssociationConnectionType : EnumAssociationConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the EnumAssociationConnectionType with the given ConnectionBuilder.
			/// </summary>
			public EnumAssociationConnectionType() : base() {}
		}
	}
}
